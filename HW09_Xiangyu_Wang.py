...
class Student:
    """Class of Students from same University"""
    ...
    def add_course(self, course, grade):
        """Add course  and grades into this instance of Student"""
        ...
        try:
            for scwid, course, grade, icwid in file_reading_gen(path, 4, sep='\t', header=False):
                ...
                if icwid in self._instructor:
                    ...
                    print(f'This instructor{icwid} is not in file!')
        except ValueError as err:
            raise ValueError(err)  # Raise a exception when encountering a bad data
...
class AutoTest(unittest.TestCase):
    ...
    def test_Stevens(self):
        path_dir = 'D:/PycharmProjects/Week9'
